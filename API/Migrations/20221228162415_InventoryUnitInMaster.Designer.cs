...
namespace API.Migrations
{
    ...
    [Migration("20221228162415_InventoryUnitInMaster")]
    partial class InventoryUnitInMaster
    {
            ...
            modelBuilder.Entity("API.Models.inventory.InventoryMaster", b =>
                {
                    ...
                    b.Property<Guid?>("InventoryUnit_id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("API.Models.inventory.InventoryMaster", b =>
                {
                    ...
                    b.HasOne("API.Models.inventory.InventoryUnit", "InventoryUnit")
                        .WithMany()
                        .HasForeignKey("InventoryUnit_id");
