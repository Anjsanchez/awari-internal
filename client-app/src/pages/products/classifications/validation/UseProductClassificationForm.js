...
import { saveProdClassification } from "../../../../utils/services/pages/products/ProductClassifications";
import {
  requestStarted,
  requestFinished,
} from "../../../../utils/store/pages/roomVariant";

const UseProductClassificationForm = (
  validate,
  onSuccessEdit,
  onSuccessAdd
) => {
  ...
  const handleDialogProceed = async () => {
    ...
    try {
      ...
      const { data } = await saveProdClassification(objEmp);
...
export default UseProductClassificationForm;
