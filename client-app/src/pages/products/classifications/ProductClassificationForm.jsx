...
import UseProductClassificationForm from "./validation/UseProductClassificationForm";
import ProductClassificationFormValidate from "./validation/ProductClassificationFormValidate";
...
const ProductClassificationForm = ({
  ...
  const {
    ...
    handleDialogProceed,
    handleDialogCancel,
  } = UseProductClassificationForm(
    ProductClassificationFormValidate,
    onSuccessEdit,
    onSuccessAdd
  );
          ...
          >
            <Grid item xs={12}>
              <MSwitch
                ...
                handleChange={handleChange}
                name="Variant Active"
                subName="Disabling this will prevent the classification/s tagged under this category from including in the transaction."
              />
            </Grid>
