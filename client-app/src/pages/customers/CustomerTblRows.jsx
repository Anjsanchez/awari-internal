          ...
          return (
            ...
            >
              ...
              <TableCell component="th" id={labelId} scope="row" padding="none">
                <Link
                  to={`/a/user-management/customers/${row._id}`}
              ...
              <TableCell align="right">
                <span className={classes.rowSpan}>{row.points}</span>
              </TableCell>
              <TableCell align="right">
                <span className={classes.rowSpan}>{row.cardAmount}</span>
              </TableCell>
              <TableCell align="right">
...
export default CustomerTblRows;
